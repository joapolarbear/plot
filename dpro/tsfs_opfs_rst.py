...
plt.xticks(x + (iter_time.shape[1]/2)*barwidth, dataset, fontsize=font_size, rotation=0)
plt.yticks(fontsize=font_size)
plt.legend(bbox_to_anchor=(0., 1.02, 1., .102), ncol=3, fontsize=font_size * 0.75)
...
plt.savefig("fig/tsfs_opfs/tsfs_opfs_a.pdf", bbox_inches='tight')
...
plt.subplots_adjust(left=0.13, bottom=0.1, right=0.95, top=0.95,
                    wspace=0.2, hspace=0.3)
plt.savefig("fig/tsfs_opfs/tsfs_opfs_b.pdf", bbox_inches='tight')
