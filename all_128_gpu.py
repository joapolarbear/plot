...
upper = 1.4*np.max(_iter_time)
plt.ylim(0, upper)
plt.yticks(np.arange(0, upper, int(upper/4//10*10)), fontsize=font_size)
...
ax2.plot(x + barwidth, mse[:, 1], '-o',
            color=color, linewidth=3, markersize=10, label="dPRO Prediction Error")
...
### Disable tensor fusion for horovod and xla
# iter_time = np.array([
...
iter_time = np.array([
    [114.963532, 146.3627002, 113.239079, 107.7776042, 106.1609401],
    [146.2487526, 185.319714, 144.0550213, 171.0253317, 132.6069187],
    [147.6898751, 168.9127873, 503.941862, 45.89069756, 134.9875185],
    [170.2215308, 228.1895807, 864.531843, 34.77122125, 143.149022],
    [230.581659, 303.2674281, 425.1975617, 348.5196193, 220.1235196],
    [520.2835991, 553.6248561, 588.671001, 489.7807123, 473.7746381],
    [874.7569403, 914.0408277, 844.8319357, 380.821546, 346.7629493],
    [1874.1539, 1830.073563, 1495.518239, 555.7611863, 538.0927985],
])
